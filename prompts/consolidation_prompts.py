...
[turn=31] 旁白: 江知夏检查完日志，合上电脑站了起来。
[turn=31] chenxiao: 那我先去通知其他人，免得大家继续担心。
[turn=31] guyining: 好，辛苦你。
[turn=32] 旁白: 江知夏离开会议室，房间里只剩玩家和顾明汐。
  ...
  "guyining": [
    {
      ...
      "reason": "turn 32 起江知夏离开，互动从多人处理危机转为顾明汐和玩家单独缓和情绪。"
    },
    {
      "end_turn": 35,
...
history:
[turn=40] 旁白: 白板上已经写满第一版功能，顾明汐把马克笔放在桌边。
